...
class SwarmRobot:
    def __init__(self):
        self._drive_motor = Motor(Motor._board.PORT_B)
        self._steer_motor = CalibratedMotor(Motor._board.PORT_D, calpow=40)
        self._fork_lift_motor = CalibratedMotor(Motor._board.PORT_C, calpow=50)
        self._fork_tilt_motor = CalibratedMotor(Motor._board.PORT_A, calpow=40)
